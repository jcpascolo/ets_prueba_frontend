    ...
    <div class="row h-100 mx-0">
      <div id="fstCol" class="col-12 col-md-2 px-0">
        ...
        <div class="row mx-0 align-items-center">          
          <FilterButton type="button" v-for="(filter, index) in filters" :key="filter.name" :filterName="filter.name" :svgD="filter.d" :isActive="filter.isActive" @click.native="toggleActiveClass(index)"/> 
        </div>
      </div>

      <div id="sndCol" class="col-12 col-md-2">{vhgvs}</div>
